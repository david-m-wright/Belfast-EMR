...
* `r nrow(filter(eye_raw, !exclude_age, !exclude_covid, !exclude_non_naive, !exclude_lt3_injections, exclude_no_fluid))` eyes did not have a retinal fluid measurement within 40 days prior to or including the index date and were excluded.   
