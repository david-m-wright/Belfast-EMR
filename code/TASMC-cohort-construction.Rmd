...
* Excluded `r nrow(filter(distinct(mdc_raw, PatientID, exclude_research_patient, exclude_covid), exclude_research_patient))` patients that were involved in a clinical trial and so received different treatments from the majority of patients.     
* Excluded `r nrow(filter(distinct(mdc_raw, PatientID, exclude_research_patient, exclude_covid), !exclude_research_patient, exclude_covid))` patients that were first treated during the Covid pandemic, a substantially different group of patients.    
