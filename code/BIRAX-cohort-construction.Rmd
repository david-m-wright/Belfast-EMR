...
* In ~10% of cases the total time under treatment was greater than the calculated observation period by up to half a year. This is likely to have been linked to the date perturbation. Where this occured set the total observation period equal to the total time under treatment.   
