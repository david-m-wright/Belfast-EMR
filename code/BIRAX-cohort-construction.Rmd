...
* `r nrow(filter(eye_raw, !exclude_no_AMD, !exclude_age, exclude_age_perturb))` eyes where event date perturbation to protect patient privacy meant that follow-up periods could not be calculated (gave negative follow-up periods).   
...
* `r nrow(filter(eye_raw, !exclude_no_AMD, !exclude_age,  !exclude_age_perturb, !exclude_lt3_injections, !exclude_RVO, !exclude_DR_DMO, !exclude_no_va, exclude_no_thickness))` eyes did not have an OCT retinal thickness measurement within 2 weeks prior to or including the index date and were excluded.   
* `r nrow(filter(eye_raw, !exclude_no_AMD, !exclude_age,  !exclude_age_perturb, !exclude_lt3_injections, !exclude_RVO, !exclude_DR_DMO, !exclude_no_va, !exclude_no_thickness, exclude_no_fluid))` eyes did not have a retinal fluid measurement within 2 weeks prior to or including the index date and were excluded.   
